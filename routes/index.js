...
router.get('/', (req, res) => {
    let testimonials = [{
        ...
        id: 4,
        text: "Los chatbots hicieron que crezca mi cartera de clientes... Buen servicio!",
    ...
    let benefitsHome = [{
            ...
            description: "Los chatbots trabajan para su organización las 24 horas, respondiendo consultas y realizando ventas de manera inmediata."
        },
        {
            id: 2,
            title: "Nuevos canales de comunicación",
            img: "images/Benefits/multiplatform.svg",
            description: "Los chatbots extienden los canales de comunicación existentes ¡Tu organización puede ofrecer servicio al cliente en las principales redes sociales y servicios de mensajería ! "
        },
        {
            id: 3,
            title: "Recolección de datos",
            img: "images/Benefits/charts.svg",
            description: "Los chatbots recolectan datos de los usuarios permanentemente ¡Puedes segmentar a tus clientes y enviar promociones de acuerdo a sus preferencias !"
        },
        {
            id: 4,
            title: "Mejores beneficios",
            img: "images/Benefits/sales.svg",
            description: "Los chatbots tienen el potencial de aumentar la satisfacción de los clientes, mejorando beneficios y reduciendo costos ¡Ahorra costes en formación y personal a tu área de atención al cliente !"
        },
    ]
    res.render('home', {
